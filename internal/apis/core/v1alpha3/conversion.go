...
func Convert_v1alpha3_MachinePoolSpec_To_v1beta1_MachinePoolSpec(in *MachinePoolSpec, out *clusterv1.MachinePoolSpec, s apiconversion.Scope) error {
	return autoConvert_v1alpha3_MachinePoolSpec_To_v1beta1_MachinePoolSpec(in, out, s)
}

func Convert_v1alpha3_MachinePool_To_v1beta1_MachinePool(in *MachinePool, out *clusterv1.MachinePool, s apiconversion.Scope) error {
...
func Convert_v1beta1_MachinePool_To_v1alpha3_MachinePool(in *clusterv1.MachinePool, out *MachinePool, s apiconversion.Scope) error {
